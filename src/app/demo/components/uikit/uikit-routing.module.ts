...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        { path: 'users2', data: { breadcrumb: 'Users2' }, loadChildren: () => import('./users2/users2.module').then(m => m.Users2Module) },
        { path: 'affecter', data: { breadcrumb: 'Affecter' }, loadChildren: () => import('./affecteranimal/affecteranimal.module').then(m => m.AffecteranimalModule) },
        { path: 'affecterplan', data: { breadcrumb: 'affecterplan' }, loadChildren: () => import('./affecterplan/affecterplan.module').then(m => m.AffecterPlanModule) },
